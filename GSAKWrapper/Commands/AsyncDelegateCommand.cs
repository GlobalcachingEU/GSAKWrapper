...
namespace GSAKWrapper.Commands
{
    public class AsyncDelegateCommand : ICommand
    {
        ...
        public bool CanExecute(object parameter)
        {
            if (_canExecute == null)
            {
                return ApplicationData.Instance.UIIsIdle;
            }

            return ApplicationData.Instance.UIIsIdle && _canExecute(parameter);
        }
        ...
        {
            ApplicationData.Instance.BeginActiviy();
            await _asyncExecute(parameter);
            ApplicationData.Instance.EndActiviy();
        }
