...
namespace GSAKWrapper.Utils
{
    public class Calculus
    {
        ...
        public static Location Convert2Location(string LatDegrees, string LatMinutes, string LonDegrees, string LonMinutes)
        {
            Location result = null;
            try
            {
                result = new Location(Conversion.StringToDouble(LatDegrees) + (Conversion.StringToDouble(LatMinutes) / 60.0),
        ...
        public static Location LocationFromRD(double x, double y)
        {
            Location result = null;
            double lattitude;
            double longitude;
        ...
        public static bool PointInPolygon(List<Location> points, Location ll)
        {
            return PointInPolygon(points, ll.Lat, ll.Lon);
        }
        public static bool PointInPolygon(List<Location> points, double lat, double lon)
        {
            bool result = false;
